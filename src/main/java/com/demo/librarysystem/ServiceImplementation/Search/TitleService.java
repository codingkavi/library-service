...
public class TitleService implements LibraryServ {
    ...
    public String findBook(String bookSearch) throws SQLException {

        String searchbyTitle = searchbyTitle(bookSearch);
        return searchbyTitle;
    }

    public String searchbyTitle(String bookSearch) throws SQLException,NullPointerException {
